...
const AboutUs = () => {
  return (
    ...
    <div className="bio-cardd card w-96 bg-base-100 shadow-xl">
      ...
      <h2 className="card-title">Daria Mordvinov</h2>
      <p>If a dog chews shoes whose shoes does he choose?</p>
      <div className="card-actions">
        <form className="about-links">
        <a className="about-links" href="https://www.github.com">
        ...
        <a className="about-links" href="https://www.linkedin.com">
    ...
    <div className="bio-cardd card w-96 bg-base-100 shadow-xl">
      <img src="https://placeimg.com/400/225/arch" alt="Shoes" className="bio-pic rounded-xl" />
      <div className="bio-body card-body items-center text-center">
      <h2 className="card-title">Kevin Dooley</h2>
      <p>If a dog chews shoes whose shoes does he choose?</p>
      <div className="card-actions">
        <form className="about-links">
        <a className="about-links" href="https://www.github.com">
    ...
    <div className="bio-cardd card w-96 bg-base-100 shadow-xl">
      <img src="https://placeimg.com/400/225/arch" alt="Shoes" className="bio-pic rounded-xl" />
      <div className="bio-body card-body items-center text-center">
      <h2 className="card-title">Dison Ruan</h2>
      <p>If a dog chews shoes whose shoes does he choose?</p>
      <div className="card-actions">
        <form className="about-links">
        <a className="about-links" href="https://www.github.com">
    ...
    <div className="bio-cardd card w-96 bg-base-100 shadow-xl">
      <img src="https://placeimg.com/400/225/arch" alt="Shoes" className="bio-pic rounded-xl" />
      <div className="bio-body card-body items-center text-center">
      <h2 className="card-title">Jason Kuyper</h2>
      <p>If a dog chews shoes whose shoes does he choose?</p>
      <div className="card-actions">
        <form className="about-links">
        <a className="about-links" href="https://www.github.com">
    ...
    <div className="bio-cardd card w-96 bg-base-100 shadow-xl">
      <img src="https://placeimg.com/400/225/arch" alt="Shoes" className="bio-pic rounded-xl" />
      <div className="bio-body card-body items-center text-center">
      <h2 className="card-title">Ryan Zarou</h2>
      <p>If a dog chews shoes whose shoes does he choose?</p>
      <div className="card-actions">
        <form className="about-links">
        <a className="about-links" href="https://www.github.com">
